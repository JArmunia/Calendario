...
public class Recordatorio implements Guardable, Identificable<GregorianCalendar> {
    ...
    /**
     * Devuelve si está en el mismo día que la fecha pasada por parámetro
     *
     * @param dia
     * @return
     */
    ...
    /**
     * Devuelve si está en el mismo mes que la fecha pasada por parámetro
     *
     * @param dia
     * @return
     */
    ...
    /**
     * Devuelve el creador del recordatorio
     *
     * @return
     */
    ...
    /**
     * Devuelve los contactos con los que se ha sincronizado el recordatorio
     *
     * @return
     */
    ...
    /**
     * Devuelve un Json del recordatorio
     * @return 
     */
    @Override
    ...
    /**
     * Devuelve los permisos que se tienen sobre el recordatorio
     * @return 
     */
    public String devuelvePermisos() {
        return permisos;
    }
}
